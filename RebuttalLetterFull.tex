% Compilation: XeLaTeX => bibtex => XeLaTeX => XeLaTeX
\documentclass[YunJing]{CoverLetter}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 设置水印
\newcommand{\WatermarkImage}{img/penn-state-shield.jpg} % 水印文件
\newcommand{\WatermarkPages}{1-2} % 放置的页面
...
\title{
    ...
    \\[-.5em]
    % long title
    % {\large \textbf{ ``Your Manuscript Title is Placed Here}} \\[-14pt]
    % {\large  \textbf{ Long Title Linebreak''}}
    % short title
    {\large  \textbf{``Your Manuscript Title is Here''}}
    \vspace{-3.5em}
}
